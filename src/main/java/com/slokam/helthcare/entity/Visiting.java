...
public class Visiting {
	 ...
	 * public Doctor getDoctor() { return doctor; } public void setDoctor(Doctor
	 * doctor) { this.doctor = doctor; } public Integer getId() { return id; }
	 * public void setId(Integer id) { this.id = id; } public Date getTime() {
	 * return time; } public void setTime(Date time) { this.time = time; }
	 */
